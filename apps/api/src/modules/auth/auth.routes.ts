...
const userProfileSchema = z.object({
  ...
  bidReadinessReady: z.boolean().optional(),
  bidReadinessStatus: z.enum(["not_ready", "ready", "payment_retry_required", "restricted"]).optional(),
  bidDefaultShippingMethodId: z.string().optional(),
  bidPaymentMethodToken: z.string().optional(),
  bidAcceptsInstantLotCharges: z.boolean().optional(),
  bidAcceptsGroupedShippingCharges: z.boolean().optional(),
  bidShippingProvider: z.enum(["packeta", "balikovna"]).optional(),
  bidPickupPointId: z.string().optional(),
  bidPickupPointLabel: z.string().optional(),
  bidShippingPrice: z.number().nonnegative().optional(),
  bidTermsAcceptedAt: z.string().optional(),
